    ...
    <div className="flex flex-wrap items-center gap-2.5">
      ...
      {applied.map((f) => (
        <button
          ...
          className="flex cursor-pointer items-center gap-2 rounded-full border-[1.5px] border-ink bg-ink px-4 py-2 text-[13px] font-bold text-white hover:bg-red hover:border-red"
        >
          {f.label}
