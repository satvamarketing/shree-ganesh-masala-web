    ...
    >
      <div className="flex w-full flex-wrap justify-center gap-2.5">
        ...
        <input
          ...
          className="box-border min-w-[240px] flex-1 rounded-full border-[1.5px] border-[#CBDDC4] bg-white px-6 py-4 text-base text-ink outline-none focus:border-forest"
        />
        <Honeypot />
        <button
          type="submit"
          disabled={state === "sending"}
          className="cursor-pointer rounded-full bg-forest px-8 py-4 text-[15.5px] font-bold text-white transition-colors hover:bg-ink disabled:cursor-wait disabled:opacity-70"
        >
